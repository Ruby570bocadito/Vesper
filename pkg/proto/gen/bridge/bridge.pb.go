...
const file_bridge_proto_rawDesc = "" +
	"\n" +
	"\fbridge.proto\x12\tvesper.v1\"\x8e\x01\n" +
	...
	"\n" +
	"elapsed_ms\x18\x04 \x01(\x03R\telapsedMs\"\xe3\x01\n" +
	...
	"\aoptions\x18\x04 \x03(\v2(.vesper.v1.AIAnalyzeRequest.OptionsEntryR\aoptions\x1a:\n" +
	...
	"moduleName\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion2\xb1\x02\n" +
	"\rBridgeService\x12D\n" +
	"\rExecuteModule\x12\x18.vesper.v1.ModuleRequest\x1a\x19.vesper.v1.ModuleResponse\x12H\n" +
	"\tAIAnalyze\x12\x1b.vesper.v1.AIAnalyzeRequest\x1a\x1c.vesper.v1.AIAnalyzeResponse0\x01\x12B\n" +
	"\vReconStream\x12\x17.vesper.v1.ReconRequest\x1a\x18.vesper.v1.ReconResponse0\x01\x12L\n" +
	"\vHealthCheck\x12\x1d.vesper.v1.HealthCheckRequest\x1a\x1e.vesper.v1.HealthCheckResponseBAZ?github.com/ruby570bocadito/vesper/pkg/proto/gen/bridge;bridgev1b\x06proto3"
...
var file_bridge_proto_goTypes = []any{
	(*ModuleRequest)(nil),       // 0: vesper.v1.ModuleRequest
	(*ModuleResponse)(nil),      // 1: vesper.v1.ModuleResponse
	(*AIAnalyzeRequest)(nil),    // 2: vesper.v1.AIAnalyzeRequest
	(*AIAnalyzeResponse)(nil),   // 3: vesper.v1.AIAnalyzeResponse
	(*ReconRequest)(nil),        // 4: vesper.v1.ReconRequest
	(*ReconResponse)(nil),       // 5: vesper.v1.ReconResponse
	(*HealthCheckRequest)(nil),  // 6: vesper.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil), // 7: vesper.v1.HealthCheckResponse
	nil,                         // 8: vesper.v1.AIAnalyzeRequest.OptionsEntry
}
var file_bridge_proto_depIdxs = []int32{
	8, // 0: vesper.v1.AIAnalyzeRequest.options:type_name -> vesper.v1.AIAnalyzeRequest.OptionsEntry
	0, // 1: vesper.v1.BridgeService.ExecuteModule:input_type -> vesper.v1.ModuleRequest
	2, // 2: vesper.v1.BridgeService.AIAnalyze:input_type -> vesper.v1.AIAnalyzeRequest
	4, // 3: vesper.v1.BridgeService.ReconStream:input_type -> vesper.v1.ReconRequest
	6, // 4: vesper.v1.BridgeService.HealthCheck:input_type -> vesper.v1.HealthCheckRequest
	1, // 5: vesper.v1.BridgeService.ExecuteModule:output_type -> vesper.v1.ModuleResponse
	3, // 6: vesper.v1.BridgeService.AIAnalyze:output_type -> vesper.v1.AIAnalyzeResponse
	5, // 7: vesper.v1.BridgeService.ReconStream:output_type -> vesper.v1.ReconResponse
	7, // 8: vesper.v1.BridgeService.HealthCheck:output_type -> vesper.v1.HealthCheckResponse
